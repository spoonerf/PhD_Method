...
pop<-read.csv("Global_Population_Lambdas.csv", sep="")
pop<-pop[,c(2,5,8,9)]

eu_clim<-read.csv("Rate_Mean_Temp_Change.csv", sep="")
eu_clim<-eu_clim[,c(2,4)]

glob_clim<-read.csv("All_LPI_All_Years_Nobuff_1931_moreLPI_end2005.csv")
glob_clim<-glob_clim[,c(2,4)]

luc_hilda<- read.csv("LPI_LandUse_121_18_09_2015.csv", sep="" )
luc_hilda<-luc_hilda[,c(2,4)]
...
bm<- read.csv("LPI_BodyMass_Amniote_Database_edit.csv", sep="")
bm<-bm[,-1]
...
luc<-luc[,c(2,4)]
bm<- read.csv(paste(wd, "/Chapter_Two/Europe/", "LPI_BodyMass_Amniote_Database_edit.csv", sep=""))
bm<-bm[,-1]
