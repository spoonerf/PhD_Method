...
Populations<-Populations[Populations$X > 5 & Populations$X < 25 & Populations$Y >50 & Populations$Y <70,]
...
#e_pop<-extent(min(Populations$X) - 1.5, max(Populations$X)+1.5,min(Populations$Y) - 1.5, max(Populations$Y)+1.5)
e_pop<-extent(5,25,50,70)
...
#test#
patch_map_mine[!is.na(patch_map_mine[,4]),4]<-1
#
