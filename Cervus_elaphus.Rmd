...
sd_seq<-0.5
LDD_seq<-c(0.1)
kern_seq<-list(c(19.775,113),c(13.5975, 77.7), c(1000,1000))   #first values is median derived from median home range and second value is maximum dispersal distance
