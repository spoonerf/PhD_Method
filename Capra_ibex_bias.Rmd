...
targetRecords <- occ_search(
  ...
  fields='minimal',
  decimalLongitude='5,16',
  decimalLatitude='43,49',
  limit=11000
)
...
if (!file.exists(paste(species_directory, "kfolds_background_data.csv", sep="/"))){
  write.csv(targetBg_k, paste(species_directory, "kfolds_background_data.csv", sep="/"))
}

group_back<-read.csv(paste(species_directory,"kfolds_background_data.csv", sep="/"))
