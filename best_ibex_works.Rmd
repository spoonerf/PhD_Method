...
```{r Presence Data, message=FALSE, warning=FALSE, eval=FALSE}
library(dismo)
...
```{r Testing and training data, eval=FALSE}
...
```{r Bioclim model, cache=TRUE, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r GAM, cache= TRUE, message=FALSE, warning=FALSE, eval=FALSE}
#library(mgcv)
...
```{r Random forest model , cache= TRUE, message= FALSE, warning=FALSE, eval=FALSE}
...
```{r Weighted ensemble one, cache=TRUE, warning=FALSE, message=FALSE, eval=FALSE}
#total models
library(randomForest)
