...
kern_mat<-matrix(c(rep(c(1,1), (nrow(var_grid)/ncol(var_grid))),rep(c(19.775,113.000), (nrow(var_grid)/ncol(var_grid))),rep(c(13.5975, 77.700), (nrow(var_grid)/ncol(var_grid))),rep(c(1000.000,1000.000),(nrow(var_grid)/ncol(var_grid)))), ncol=2, byrow=T)
...
highfoldernames<-highfoldernames[1:4]
