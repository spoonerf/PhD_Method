...
min_lat<- 45   #one degree more/less than the iucn breeding range extent
max_lat<- 85
min_lon<- 5
max_lon<- 180

e_iucn<-extent(min_lon, max_lon, min_lat, max_lat)
bioclim_layers<-c(6,8,10,11,13,16,19)    # Susan E. Lee, Malcolm C. Press, John A. Lee, Tim Ingold & Terhi Kurttila
#(2000) Regional effects of climate change on reindeer: a case study of the Muotkatunturi region in
#Finnish Lapland, Polar Research, 19:1, 99-105, DOI: 10.3402/polar.v19i1.6535
...
targetRecords <- occ_search(
  ...
  fields='minimal',
  decimalLongitude='5,180',
  decimalLatitude='45,85',
  limit=11000
)
...
for (i in 1:k){
  ...
  gm1<-mgcv:::gam(pa~ s(Bio_6_2006_2016_average)+s(Bio_8_2006_2016_average)+ s(Bio_10_2006_2016_average)+ 
           s(Bio_11_2006_2016_average)+ s(Bio_13_2006_2016_average)+  s(Bio_16_2006_2016_average)+    s(Bio_19_2006_2016_average)+s(Hyde_Year_2005), family = binomial(link = "logit"),data=envtrain)
...
model<-pa ~  Bio_6_2006_2016_average+Bio_8_2006_2016_average+ 
  Bio_10_2006_2016_average+ Bio_11_2006_2016_average+ Bio_13_2006_2016_average+ Bio_16_2006_2016_average+Bio_19_2006_2016_average+Hyde_Year_2005
...
gm1<-gam(pa~ s(Bio_6_2006_2016_average)+s(Bio_8_2006_2016_average)+ s(Bio_10_2006_2016_average)+ 
           s(Bio_11_2006_2016_average)+ s(Bio_13_2006_2016_average)+  s(Bio_16_2006_2016_average)+    s(Bio_19_2006_2016_average)+s(Hyde_Year_2005), family = binomial(link = "logit"),data=env_all)
