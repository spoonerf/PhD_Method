...
Inc5MammalsTemp <- subset(LPI2, !is.na(MnSlope50k)&r_sq >= 0.5  & !is.na(change_rate_49)&length_time >= 10 & System != "Marine")
...
for (i in 1:R) {
  ...
  # n1f<-lmer(lambda_mean ~ mean_slope_scale*mean_var_scale+(1|Binomial),data=sp_dups_df2)
   ...
   # m1g<-lmer(lambda_mean ~ change_rate_scale*prec_var_scale+(1|Binomial),data=sp_dups_df2, REML=F)
 ...
 #  n2d<-lmer(lambda_mean ~change_rate_scale+(1|Binomial),data=sp_dups_df2)
  ...
  #  n2e<-lmer(lambda_mean ~mean_slope_scale+(1|Binomial),data=sp_dups_df2)
    ...
    #m2g<-lmer(lambda_mean ~ prec_var_scale+ (1|Binomial), data=sp_dups_df2, REML=F)
