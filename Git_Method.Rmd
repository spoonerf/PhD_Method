...
parm_df<-sp_dups_df[,c("ID","Estimate", "SE", "change_rate_9")]  ##ID, land use, and climate
...
parm_scale<-scale(parm_mat[,c("Estimate", "SE", "change_rate_9")])       #use the scaling factors at the bottom of these to scale the rasters
...
#    n2c<-lmer(TL ~mean_slope_scale+mean_var_scale+(1|Binomial_old),data=sp_dups_df2)
  ...
  #  n2d<-lmer(TL ~change_rate_scale+(1|Binomial_old),data=sp_dups_df2)
   ...
   # n2f<-lmer(TL ~mean_var_scale+(1|Binomial_old),data=sp_dups_df2, REML=F)
      ...
      models_list<-list(m1,m1a,m1b,m1c,m1d,m1e,m1f,m2,m2a,m2b,m2c,m2d,m2e,m2f)
