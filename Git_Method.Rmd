...
Inc5MammalsTemp <- subset(LPI_EDScores2, !is.na(change_rate_25)&!is.na(mean_slope) &System != "Marine"&length_time >= 10)
...
Inc5MammalsTemp <- subset(LPI_EDScores2, !is.na(hot_avg)&!is.na(Estimate25k)&r_sq2 >= 0.5  & !is.na(change_rate_25) &length_time >= 10 & System != "Marine")
 ...
 #  n2d<-lmer(TL ~change_rate_scale+(1|Binomial_old),data=sp_dups_df2)
  ...
  #  n2e<-lmer(TL ~mean_slope_scale+(1|Binomial_old),data=sp_dups_df2)
   ...
   # n2f<-lmer(TL ~mean_var_scale+(1|Binomial_old),data=sp_dups_df2, REML=F)
    ...
    mnull<-lmer(TL ~1+(1|Binomial_old),data=sp_dups_df2, REML=F)
