...
for (i in 1:R) {
  ...
  cond_Rsq_m1c[i]<-modelsRsq[2,5]   #should be 4 without all other models '#'d out
...
lowCI_av<-c(sort(int_av)[3],sort(LUC_av)[3],sort(MTV_av)[3],sort(MTC_av)[3],sort(LUC_MTV_av)[3],sort(LUC_MTC_av)[3],sort(MTC_MTV_av)[3])
