...
for (i in 1:R) {
  ...
  nodels_list<-list(n1,n1a,n1b,n1c,n1d,n1e,n1f,n2,n2a,n2b,n2c,n2d,n2e,n2f)
...
LowCI_RSq<-c(sort(marg_Rsq_m1)[25],sort(cond_Rsq_m1)[25])   #should be 250 for R=9999
HighCI_RSq<-c(sort(marg_Rsq_m1)[975],sort(cond_Rsq_m1)[975]) #should be 9750 for R=9999
...
RSq_add<-rbind(LowCI_RSq2, Mean_RSq2, HighCI_RSq2)
colnames(RSq_add)<-Var_RSq
RSq_add
