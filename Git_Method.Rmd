...
lowCI2<-c(sort(intercept2)[250],sort(change_rate2)[250],sort(mean_se2)[250],sort(mean_slope2)[250], sort(change_mean_se2)[250], sort(mean_se_mean_slope)[250])

highCI2<-c(sort(intercept2)[9750],sort(change_rate2)[9750],sort(mean_se2)[9750],sort(mean_slope2)[9750], sort(change_mean_se2)[9750], sort(mean_se_mean_slope)[9750])
