...
LPI_EDScores2<-merge(LPI_EDScores, LU_sens, by="ID",all=T)
...
```{r}
Inc5MammalsTemp <- subset(LPI_EDScores2, !is.na(MnSlope50k)&r_sq >= 0.5  & !is.na(change_rate_49)&length_time >=30 & System != "Marine" & !is.na(Bodymass))
