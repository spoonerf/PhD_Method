...
setwd("D:/Fiona/PhD1/Git_Directory/PhD1/Method_RMd")
rm(list=ls())
...
all_matrix <- matrix(unlist(all_df_list), ncol=12, byrow=TRUE)
...
hist(all_df$missing_years, breaks=100, xlab="Number of Population Estimates within the Time Series", main="")
...
```{r}
all_df<-read.csv("C:/Users/Fiona/Desktop/PhD/Git_Directory/PhD1/Method_RMd/Europe_Population_Trends_Rsq_Lambda_12_09_15.csv")
...
LPI<-read.csv("C:/Users/Fiona/Desktop/PhD/Git_Directory/PhD1/Method_RMd/LPI_populations_IP_fishedit_20140310_nonconf.csv", stringsAsFactors=FALSE)
...
xmax<-brick("C:/Users/Fiona/Desktop/PhD/Git_Directory/PhD1/Method_RMd/Europe_maxt_mon.grd")
...
```{r}
#xmin <- brick("C:/Users/Fiona/Desktop/PhD/R_Directory/PhD/Europe Data/Climate_Proc#essed/Europe_mint_mon.grd")

xmin<- brick("C:/Users/Fiona/Desktop/PhD/Git_Directory/PhD1/Method_RMd/Europe_mint_mon.grd")

plot(xmin[[1]],legend.shrink=0.75,main="Average Daily Minimum Temperature - January 1950", xlab="Longitude", ylab="Latitude", legend.args=list(text='Degrees Celsius',side=4, font=2, line=2.5, cex=0.8))
```
...
```{r}
#xpcp2<-brick("C:/Users/Fiona/Desktop/PhD/R_Directory/PhD/Europe Data/Climate_Proce#ssed/Europe_pcp_mon.grd")

xpcp2<-brick("C:/Users/Fiona/Desktop/PhD/Git_Directory/PhD1/Method_RMd/Europe_pcp_mon.grd")

plot(xpcp2[[1]],legend.shrink=0.75,main="Summed Daily Precipitation - January 1950", xlab="Longitude", ylab="Latitude", legend.args=list(text='Millimetres',side=4, font=2, line=2.5, cex=0.8))
```
...
all_EU_mean_data<-read.csv("C:/Users/Fiona/Desktop/PhD/all_EU_mean_data_check_21_08_15.csv")
all_EU_max_data<-read.csv("C:/Users/Fiona/Desktop/PhD/Git_Directory/PhD1/Method_RMd/all_EU_max_data_check_24_08_15_50kbuffnarm.csv")
all_EU_min_data<-read.csv("C:/Users/Fiona/Desktop/PhD/Git_Directory/PhD1/Method_RMd/all_EU_min_data_24_08_15_50kbuffnarm.csv")
all_EU_pcp_data<-read.csv("C:/Users/Fiona/Desktop/PhD/Git_Directory/PhD1/Method_RMd/all_EU_pcp_data_24_08_15_50kbuffnarm.csv")
...
EUclim_new<-read.csv("C:/Users/Fiona/Desktop/PhD/Git_Directory/PhD1/Method_RMd/all_EU_clim_data_28_09_15_50kbuffnarm.csv")
...
r_1950 <-raster(readAsciiGrid("C:/Users/Fiona/Desktop/PhD/Land_Use/HILDA/Gross_Final_1km_EU27CH_ASCII/eu27ch1950.asc"))
r_1960 <-raster(readAsciiGrid("C:/Users/Fiona/Desktop/PhD/Land_Use/HILDA/Gross_Final_1km_EU27CH_ASCII/eu27ch1960.asc"))
r_1970 <-raster(readAsciiGrid("C:/Users/Fiona/Desktop/PhD/Land_Use/HILDA/Gross_Final_1km_EU27CH_ASCII/eu27ch1970.asc"))
r_1980 <-raster(readAsciiGrid("C:/Users/Fiona/Desktop/PhD/Land_Use/HILDA/Gross_Final_1km_EU27CH_ASCII/eu27ch1980.asc"))
r_1990 <-raster(readAsciiGrid("C:/Users/Fiona/Desktop/PhD/Land_Use/HILDA/Gross_Final_1km_EU27CH_ASCII/eu27ch1990.asc"))
r_2000 <-raster(readAsciiGrid("C:/Users/Fiona/Desktop/PhD/Land_Use/HILDA/Gross_Final_1km_EU27CH_ASCII/eu27ch2000.asc"))
r_2010 <-raster(readAsciiGrid("C:/Users/Fiona/Desktop/PhD/Land_Use/HILDA/Gross_Final_1km_EU27CH_ASCII/eu27ch2010.asc"))
...
```{r}
r<-brick("C:/Users/Fiona/Desktop/PhD/Git_Directory/PhD1/Method_RMd/Land_Use_1950_2010.grd")
...
LPI_LUC<-read.csv("C:/Users/Fiona/Desktop/PhD/Git_Directory/PhD1/Method_RMd/LPI_populations_IP_fishedit_20140310_nonconf.csv")
...
xmin<- colFromX(r[[1]], points[1:length(points),]) - 12
xmax<- colFromX(r[[1]], points[1:length(points),]) + 12
ymin<- rowFromY(r[[1]], points[1:length(points),]) - 12
ymax<- rowFromY(r[[1]], points[1:length(points),]) + 12    #changed from 5 to 12
...
par(xpd=TRUE)
legend(5231419,3867409, legend = c("Settlement", "Cropland", "Forest", "Grassland", "Other Land", "Water"), fill = colors)
...
```{r}
LPI_LUC_selm<-read.csv("C:/Users/Fiona/Desktop/PhD/Git_Directory/PhD1/Method_RMd/LPI_LandUse_121_18_09_2015.csv")

hist(LPI_LUC_selm$change_rate, breaks=100, main="Histogram of Land Use Change for each Time Series", xlab="Land Use Change in Surrounding 121km^2 over Time Series")

hist(LPI_LUC_selm$log_change_rate, breaks=100, main="Histogram of Logged(base 10) Land Use Change for each Time Series", xlab="Land Use Change in Surrounding 121km^2 over Time Series")
...
```{r,eval=FALSE}
# Clim<-read.csv("C:/Users/Fiona/Desktop/PhD/Git_Directory/PhD1/Climate_Slopes_08_09_15_50kmbuffnarm.csv")
# 
# LU<-read.csv("C:/Users/Fiona/Desktop/PhD/Git_Directory/PhD1/all_EU_Land_Use_Change_26_08_15.csv")
...
# Traits<-read.csv("C:/Users/Fiona/Desktop/PhD/R_Directory/PhD/Model Input/LPI_pops_20150529_EDRank2.csv")
# Pop_all<-read.csv("C:/Users/Fiona/Desktop/PhD/Git_Directory/PhD1/All_Population_Trends_Rsq_Lambda_18_08_15.csv")
####
...
LU<-read.csv("C:/Users/Fiona/Desktop/PhD/Git_Directory/PhD1/Method_RMd/LPI_LandUse_625_29_09_2015.csv")
...
#Pop<-read.csv("C:/Users/Fiona/Desktop/PhD/R_Directory/PhD/Use_This/Fitted_Population_Trends_Rsq_Lambda_18_08_15.csv") #POpulations with model Rsq >0.5
Traits<-read.csv("C:/Users/Fiona/Desktop/PhD/Git_Directory/PhD1/Method_RMd/LPI_pops_20150529_EDRank2.csv")
...
Pop_all<-read.csv("C:/Users/Fiona/Desktop/PhD/Git_Directory/PhD1/Method_RMd/Europe_Population_Trends_Rsq_Lambda_26_10_15.csv")
...
```{r}
Clim<-read.csv("Climate_Slopes_17_10_15_50kmbuffnarm.csv")
...
clim_all<-merge(Clim, Traits, by="ID")
clim_all2<-merge(clim_all, Pop_all, by="ID")

#write.csv(mess_all, "2015_09_29_LMEModel_data3.csv") 
write.csv(clim_all2, "2015_11_09_ClimateModel_data.csv")
...
Climate_Temp<- subset(Clim_pop, !is.na(max_slope_se)&!is.na(max_slope)&r_sq2 >= 0.5 &Include5 == "Yes"&Class != "Amphibia" )
...
coefs <- ddply(clim_dups_df, .(Class), function(df) {
  m <- lm(TL ~ log10(mean_slope_se), data=df)
  n<- summary(lm(TL ~ log10(mean_slope_se), data=df))
...
q<-lm(clim_dups_df$TL ~ clim_dups_df$mean_slope_se)

library(ggplot2)
p<-ggplot(clim_dups_df,aes(x=log10(mean_slope_se),y=TL,color=Class)) +geom_point(size=3) 
...
m1<-lm(clim_dups_df2$TL~log10(clim_dups_df2$mean_slope_se))
AIC_m1[i]<-AIC(m1)
...
m2<-lm(clim_dups_df2$TL~log10(clim_dups_df2$mean_slope_se)*clim_dups_df2$mean_slope)
AIC_m2[i]<-AIC(m2)
...
clim_no_dups<-subset(clim_dups_df, V1==1)

clim_count_nodups<-clim_no_dups[,c(5,86:150)]
Year_data_nodups<-colSums(!is.na(clim_count_nodups[,c(2:66)]))
Years<-1950:2014

plot(Years,Year_data_nodups, type="l", xlab= "Year", ylab="Number of population counts", main="Climate data no duplicates")

nrow(clim_no_dups)

r<-lm(clim_no_dups$TL ~ clim_no_dups$mean_slope_se)


p<-ggplot(clim_no_dups,aes(x=log10(mean_slope_se),y=TL,color=Class)) +geom_point(size=3) 
p + geom_smooth(aes(group=Class), method="lm") + xlab("Log10 Standard Error of Mean Temperature") +ylab("Total Lambda") + scale_colour_discrete(name="Class",breaks=c("Aves", "Mammalia"),labels=c("Birds", "Mammals"))

mp<-lm(Inc5MammalsTemp$TL~log10(Inc5MammalsTemp$mean_slope_se))
summary(mp)


coefs <- ddply(clim_no_dups, .(Class), function(df) {
  m <- lm(TL ~ log10(mean_slope_se), data=df)
  n<- summary(lm(TL ~ log10(mean_slope_se), data=df))
  data.frame(Intercept = coef(m)[1], Slope = coef(m)[2], R_Sq=n$r.squared, PValue=pf(n$fstatistic[1], n$fstatistic[2], n$fstatistic[3],
     lower.tail = FALSE))
})
...
#center_scale(LPI_EDScores$mean_slope)
...
sp_no_dups<-subset(sp_dups_df, V1==1)
...
Years<-1950:2014
plot(Years,Year_data, type="l", xlab= "Year", ylab="Number of population counts", main="mixed effects data with reps")
...
map <- get_map(location = bbox, source ="google",color = "bw")
ggmap(map, fullpage = TRUE) 
mapPoints <- ggmap(map) + geom_point(aes(x = Longitude, y = Latitude, size = V1), color="red", data = sp_dups_mamm, alpha = .3)+scale_size_continuous(range = c(3,10),name="Number of Populations") +labs(x = "Longitude", y = "Latitude")+ggtitle("Location of Mammal Populations")+scale_colour_discrete(guide=F)
mapPoints + theme(axis.title=element_text(size=16), title=element_text(size=20))
###bootstrapping
...
parm_df<-sp_dups_df[,c(6,20,21,24)]
parm_bird<-sp_dups_bird[,c(6,20,21,24)]
parm_mamm<-sp_dups_mamm[,c(6,20,21,24)]

parm_mat<-as.matrix(parm_df)
parm_bird_mat<-as.matrix(parm_bird)
parm_mamm_mat<-as.matrix(parm_mamm)

parm_scale<-scale(parm_mat[,c(2:4)])
parm_bird_scale<-scale(parm_bird_mat[,c(2:4)])
parm_mamm_scale<-scale(parm_mamm_mat[,c(2:4)])

parm_id<-parm_mat[,1]
parm_bird_id<-parm_bird_mat[,1]
parm_mamm_id<-parm_mamm_mat[,1]
...
colnames(parm_df_scale)<-c("ID", "mean_slope_scale", "mean_slope_se_scale", "change_rate_scale")

colnames(parm_birddf_scale)<-c("ID", "mean_slope_scale", "mean_slope_se_scale", "change_rate_scale")

colnames(parm_mammdf_scale)<-c("ID", "mean_slope_scale", "mean_slope_se_scale", "change_rate_scale")
...
#not sure if the raster values have to be scaled if the model inputs are - probably?
...
mb<-lmer(TL ~ log10(change_rate+1)*log10(mean_slope_se)+log10(change_rate+1)*mean_slope+mean_slope*log10(mean_slope_se) +(1|Binomial_old)+(1|Country),data=dt_bird)
models_list<-list(mb)
modelsR<-lapply(models_list,rsquared.glmm)
modelsRsq <- matrix(unlist(modelsR), ncol=6, byrow=T)


mm<-lmer(TL ~ log10(change_rate+1)*log10(mean_slope_se)+log10(change_rate+1)*mean_slope+mean_slope*log10(mean_slope_se) +(1|Binomial_old)+(1|Country),data=dt_mamm)
models_list<-list(mm)
modelsR<-lapply(models_list,rsquared.glmm)
modelsRsq <- matrix(unlist(modelsR), ncol=6, byrow=T)


mn<-lmer(TL ~ log10(change_rate+1)*log10(mean_slope_se)+log10(change_rate+1)*mean_slope+mean_slope*log10(mean_slope_se)+(1|Binomial_old)+(1|Country),data=dt)

mn_bird<-lmer(TL ~ log10(change_rate+1)*log10(mean_slope_se)+log10(change_rate+1)*mean_slope+mean_slope*log10(mean_slope_se)+(1|Binomial_old)+(1|Country),data=dt_bird)

mn_mamm<-lmer(TL ~ log10(change_rate+1)*log10(mean_slope_se)+log10(change_rate+1)*mean_slope+mean_slope*log10(mean_slope_se)+(1|Binomial_old)+(1|Country),data=dt_mamm)


rc<-stack("land_clim_se_stack.tif")
names(rc)<-c("change_rate", "mean_slope", "mean_slope_se")
rcm<-as.matrix(rc) # from total land use change code
rcmd<-data.frame(rcm)


p3 <- predict(mn,rcmd,re.form=NA)  
p3_bird <- predict(mn_bird,rcmd,re.form=NA)
p3_mamm <- predict(mn_mamm,rcmd,re.form=NA)

p4<-raster(matrix(p3, nrow=201, ncol=464, byrow=T))
p4_bird<-raster(matrix(p3_bird, nrow=201, ncol=464, byrow=T))
p4_mamm<-raster(matrix(p3_mamm, nrow=201, ncol=464, byrow=T))

extent(p4)<-c(-40.5,75.5,25.25,75.5)
extent(p4_bird)<-c(-40.5,75.5,25.25,75.5)
extent(p4_mamm)<-c(-40.5,75.5,25.25,75.5)

projection(p4)<-"+proj=longlat +datum=WGS84 +ellps=WGS84 +towgs84=0,0,0"
projection(p4_bird)<-"+proj=longlat +datum=WGS84 +ellps=WGS84 +towgs84=0,0,0"
projection(p4_mamm)<-"+proj=longlat +datum=WGS84 +ellps=WGS84 +towgs84=0,0,0"

plot(p4, main="change_rate*mean_slope + change_rate*mean_slope_se+mean_slope*mean_slope_se")

plot(p4_bird, main="change_rate*mean_slope + change_rate*mean_slope_se+mean_slope*mean_slope_se")

plot(p4_mamm, main="change_rate*mean_slope + change_rate*mean_slope_se+mean_slope*mean_slope_se")

writeRaster(p4, "change_mean_slope_mean_se_int.tif", format="GTiff", overwrite=TRUE)
####reform=NA
...
m1<-lmer(TL ~change_rate_scale*mean_slope_se_scale+change_rate_scale*mean_slope_scale+mean_slope_scale*mean_slope_se_scale+(1|Binomial_old)+(1|Country),data=sp_dups_df2)
models_list<-list(m1)
modelsR<-lapply(models_list,rsquared.glmm)
modelsRsq <- matrix(unlist(modelsR), ncol=6, byrow=T)
marg_Rsq[i]<-modelsRsq[1,4]
cond_Rsq[i]<-modelsRsq[1,5]
AIC_m1[i]<-AIC(m1)
...
hist(marg_Rsq, breaks=100)
hist(cond_Rsq, breaks=100)
...
RSq_df<-cbind(marg_Rsq,cond_Rsq)
Var_RSq<-c("Marginal R Squared","Conditional R Squared")
Mean_RSq<-c(mean(marg_Rsq),mean(cond_Rsq))
LowCI_RSq<-c(sort(marg_Rsq)[250],sort(cond_Rsq)[250])
HighCI_RSq<-c(sort(marg_Rsq)[9750],sort(cond_Rsq)[9750])
...
#taking out change_rate*mean_slope - which is massive
plotCI(1:8, mean_conf[c(1:7,9)], (highCI[c(1:7,9)]-mean_conf[c(1:7,9)]), (mean_conf[c(1:7,9)]-lowCI[c(1:7,9)]), ylab="Confidence Intervals", xlab="" ,xaxt = "n")
axis(1, at=1:8, labels=colnames(conf)[c(1:7,9)], las=2)

####R Squared
plotCI(1:2, Mean_RSq,(HighCI_RSq-Mean_RSq), (Mean_RSq-LowCI_RSq),ylab="Confidence Intervals", xlab="" ,xaxt = "n")
axis(1, at=1:2, labels=Var_RSq, las=2)
...
pop_count_nodups<-sp_no_dups[,c(5,99:163)]
Year_data_nodups<-colSums(!is.na(pop_count_nodups[,c(2:66)]))
Years<-1950:2014

plot(Years,Year_data_nodups, type="l", xlab= "Year", ylab="Number of population counts", main="mixed effects data No duplicates")

library(ggmap)
library(mapproj)

map <- get_map(location = 'Europe', zoom = 4, source ="google",color = "bw")
mapPoints<- ggmap(map) + geom_point(aes(x = Longitude, y = Latitude, size = V1), color="red", data = sp_no_dups, alpha = .5) +labs(x = "Longitude", y = "Latitude")+ggtitle("Location of Populations - No Duplicates")+theme(legend.position = "none")
mapPoints + theme(axis.title=element_text(size=16), title=element_text(size=20))
...
m23<-lmer(TL ~ log10(change_rate+1)*log10(mean_slope_se)+log10(change_rate+1)*mean_slope+mean_slope*log10(mean_slope_se) +(1|Binomial_old)+(1|Country),data=sp_no_dups)
plot(effect("log10(change_rate + 1)*mean_slope",xlevels=4, m23, factor.names=FALSE, layout=c(5,1), alternating=FALSE))
plot(effect("log10(change_rate + 1)*log10(mean_slope_se)", m23, factor.names=FALSE, layout=c(5,1), alternating=FALSE))
plot(effect("log10(mean_slope_se)*mean_slope", m23, factor.names=FALSE, layout=c(5,1), alternating=FALSE))
