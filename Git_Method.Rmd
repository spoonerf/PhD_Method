...
LPI_EDScores2<-merge(LPI_EDScores, res_mean, by="ID")
...
Inc5MammalsTemp <- subset(LPI_EDScores2, !is.na(mean_slope)&r_sq2 >= 0.5  & !is.na(change_rate)&length_time >= 5  & System != "Marine")
