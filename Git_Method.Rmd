...
for (i in 1:R) {
 ...
 #  n2d<-lmer(lambda_mean ~change_rate_scale+(1|Binomial),data=sp_dups_df2)
  ...
  #  n2e<-lmer(lambda_mean ~mean_slope_scale+(1|Binomial),data=sp_dups_df2)
    ...
    m3<-lmer(lambda_mean ~mean_slope_scale+Bodymass+(1|Binomial),data=sp_dups_df2, REML=F)
   # n2f<-lmer(lambda_mean ~mean_var_scale+(1|Binomial),data=sp_dups_df2, REML=F)
