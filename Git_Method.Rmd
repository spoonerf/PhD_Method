...
parm_scale<-scale(parm_mat[,c(2:4)])       #use the scaling factors at the bottom of these to scale the rasters
...
m2<-lmer(TL ~change_rate_scale+mean_slope_scale+mean_slope_se_scale+(1|Binomial_old)+(1|Country),data=sp_dups_df2)
