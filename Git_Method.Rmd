...
parm_df<-sp_dups_df[,c("ID","mean_slope", "mean_slope_se", "change_rate_25")]  ##ID, land use, and climate
...
parm_scale<-scale(parm_mat[,c("mean_slope", "mean_slope_se", "change_rate_25")])       #use the scaling factors at the bottom of these to scale the rasters
