...
```{r}
Inc5MammalsTemp <- subset(LPI_EDScores2, !is.na(MnSlope50k)&r_sq >= 0.5  & !is.na(change_rate_49)&length_time >=15 & !is.na(Bodymass) &System!="Marine" )
...
for (i in 1:R) {
  ...
  sp_dups_df2<-sp_df_scale[sp_df_scale$ID %in% dt2$ID,]
    ...
    m1<-lmer(lambda_sum ~ change_rate_scale+mean_slope_scale+mean_var_scale+change_rate_scale:mean_slope_scale+change_rate_scale:mean_var_scale+mean_slope_scale:mean_var_scale+(1|Binomial),data=sp_dups_df2, REML=F)
  #n1<-lmer(lambda_sum ~ change_rate_scale+mean_slope_scale+mean_var_scale+change_rate_scale:mean_slope_scale+change_rate_scale:mean_var_scale+mean_slope_scale:mean_var_scale+(1|Binomial),data=sp_dups_df2)
    
    m1a<-lmer(lambda_sum ~ change_rate_scale+mean_slope_scale+mean_var_scale+change_rate_scale:mean_slope_scale+change_rate_scale:mean_var_scale+(1|Binomial),data=sp_dups_df2, REML=F)
  # n1a<-lmer(lambda_sum ~ change_rate_scale+mean_slope_scale+mean_var_scale+change_rate_scale:mean_slope_scale+change_rate_scale:mean_var_scale+(1|Binomial),data=sp_dups_df2)
    
    m1b<-lmer(lambda_sum ~ change_rate_scale+mean_slope_scale+mean_var_scale+change_rate_scale:mean_slope_scale+mean_slope_scale:mean_var_scale+(1|Binomial),data=sp_dups_df2, REML=F)
   #n1b<-lmer(lambda_sum ~ change_rate_scale+mean_slope_scale+mean_var_scale+change_rate_scale:mean_slope_scale+mean_slope_scale:mean_var_scale+(1|Binomial),data=sp_dups_df2)

    m1c<-lmer(lambda_sum ~ change_rate_scale+mean_slope_scale+mean_var_scale+change_rate_scale:mean_var_scale+mean_slope_scale:mean_var_scale+(1|Binomial),data=sp_dups_df2, REML=F)
   #n1c<-lmer(lambda_sum ~ change_rate_scale+mean_slope_scale+mean_var_scale+change_rate_scale:mean_var_scale+mean_slope_scale:mean_var_scale+(1|Binomial),data=sp_dups_df2)
    
    m1d<-lmer(lambda_sum ~ change_rate_scale*mean_slope_scale+(1|Binomial),data=sp_dups_df2, REML=F)
  # n1d<-lmer(lambda_sum ~ change_rate_scale*mean_slope_scale+(1|Binomial),data=sp_dups_df2)
  
    m1e<-lmer(lambda_sum ~ change_rate_scale*mean_var_scale+(1|Binomial),data=sp_dups_df2, REML=F)
  # n1e<-lmer(lambda_sum ~ change_rate_scale*mean_var_scale+(1|Binomial),data=sp_dups_df2)
    
    m1f<-lmer(lambda_sum ~ mean_slope_scale*mean_var_scale+(1|Binomial),data=sp_dups_df2, REML=F)
  # n1f<-lmer(lambda_sum ~ mean_slope_scale*mean_var_scale+(1|Binomial),data=sp_dups_df2)
    
    m2<-lmer(lambda_sum ~change_rate_scale+mean_slope_scale+mean_var_scale+(1|Binomial),data=sp_dups_df2, REML=F)
  #n2<-lmer(lambda_sum ~change_rate_scale+mean_slope_scale+mean_var_scale+(1|Binomial),data=sp_dups_df2)
    
    m2a<-lmer(lambda_sum ~change_rate_scale+mean_slope_scale+(1|Binomial),data=sp_dups_df2, REML=F)
  #  n2a<-lmer(lambda_sum ~change_rate_scale+mean_slope_scale+(1|Binomial),data=sp_dups_df2)
    
    m2b<-lmer(lambda_sum ~change_rate_scale+mean_var_scale+(1|Binomial),data=sp_dups_df2, REML=F)
 #  n2b<-lmer(lambda_sum ~change_rate_scale+mean_var_scale+(1|Binomial),data=sp_dups_df2)
    
    m2c<-lmer(lambda_sum ~mean_slope_scale+mean_var_scale+(1|Binomial),data=sp_dups_df2, REML=F)
  # n2c<-lmer(lambda_sum ~mean_slope_scale+mean_var_scale+(1|Binomial),data=sp_dups_df2)
    
    m2d<-lmer(lambda_sum ~change_rate_scale+(1|Binomial),data=sp_dups_df2, REML=F)
 #  n2d<-lmer(lambda_sum ~change_rate_scale+(1|Binomial),data=sp_dups_df2)
    
    m2e<-lmer(lambda_sum ~mean_slope_scale+(1|Binomial),data=sp_dups_df2, REML=F)
  #  n2e<-lmer(lambda_sum ~mean_slope_scale+(1|Binomial),data=sp_dups_df2)
    
    m2f<-lmer(lambda_sum ~mean_var_scale+(1|Binomial),data=sp_dups_df2, REML=F)

    m3<-lmer(lambda_sum ~ Bodymass +(1|Binomial),data=sp_dups_df2, REML=F)
    
    m4<-lmer(lambda_sum ~ Bodymass+mean_var_scale+mean_slope_scale+change_rate_scale +(1|Binomial),data=sp_dups_df2, REML=F)
    
    mnull<-lmer(lambda_sum ~(1|Binomial),data=sp_dups_df2, REML=F)
