...
parm_df<-sp_dups_df[,c("ID","Estimate50k", "cold_avg", "change_rate_49")]  ##ID, land use, and climate

parm_mat<-as.matrix(parm_df)
parm_scale<-scale(parm_mat[,c("Estimate50k", "cold_avg", "change_rate_49")])       #use the scaling factors at the bottom of these to scale the rasters
