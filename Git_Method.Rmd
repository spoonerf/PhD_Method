...
bird_2match<-bird_com_nomatch[bird_com_nomatch$Binomial %in% Inc5MammalsTemp$Binomial,]   #checking which ones I actually need - using Inc5MammalsTemp from later chunk
...
LPI_EDScores2<-merge(LPI_EDScores, LU_sens, by="ID")
LPI_EDScores2<-merge(LPI_EDScores2, clim_sens, by="ID")
LPI_EDScores2<-merge(LPI_EDScores2, res_mean, by="ID")
LPI_EDScores2<-merge(LPI_EDScores2, res_prec, by="ID")
...
```{r}
Inc5MammalsTemp <- subset(LPI2, !is.na(MnSlope50k)&r_sq >= 0.5  & !is.na(change_rate_49)&length_time >=30 & System != "Marine" & Class=="Mammalia")
...
AIC_df<-data.frame(cbind(AIC_m1,AIC_m1a, AIC_m1b, AIC_m1c, AIC_m1d, AIC_m1e, AIC_m1f,AIC_m1g, AIC_m2,AIC_m2a, AIC_m2b, AIC_m2c, AIC_m2d, AIC_m2e, AIC_m2f,AIC_m2g, AIC_m3, AIC_mnull))
