---
title: "Making a Country Level Map"
...
The level refers to the administrative level, so level 0 will just give you the country outline and level 1 will give you the regional boundaries.
...
#GB<-readOGR("GBR_adm1",layer="GBR_adm1.shp")
...
Reprojecting might not make a huge amount of difference to countries on the equator, but it is good practice to set an appropriate projection for your work.
