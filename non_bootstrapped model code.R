...
nrow(df2)
library(dplyr)
df_hab<-select(df2, "Forest","Savanna", "Shrubland", "Grassland", "Wetland_Inland", "Rocky_areas", "Caves", "Desert") 

#percentage of generalist species
sum(rowSums(df_hab  !="NULL") >1)/sum(rowSums(df_hab  !="NULL") >0)
