...
locs<-subset(df, !is.na(Estimate)&r_sq >= 0.49999999  & !is.na(both_change)&length_time >=5 & System!="Marine" &Specific_location == 1 &(Class=="Mammalia"|Class=="Aves"))
...
#locs<-read.csv("LPI_locations.csv")
```
