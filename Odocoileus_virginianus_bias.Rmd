...
bioclim_layers<-c(1,2,4,5,6,11,19)   
...
targetRecords <- occ_search(
  ...
  fields='minimal',
  decimalLongitude='-132,-48',
  decimalLatitude='-19,63',
  limit=11000
)
...
for (i in 1:k){
  ...
  gm1<-mgcv:::gam(pa~ s(Bio_1_2006_2016_average)+s(Bio_2_2006_2016_average)+s(Bio_4_2006_2016_average)+s(Bio_5_2006_2016_average)+ s(Bio_6_2006_2016_average)+ s(Bio_11_2006_2016_average)+ s(Bio_19_2006_2016_average)+ s(Hyde_Year_2005), family = binomial(link = "logit"),data=envtrain)
...
model<-pa ~  Bio_1_2006_2016_average+Bio_2_2006_2016_average+Bio_4_2006_2016_average+Bio_5_2006_2016_average+ 
  Bio_6_2006_2016_average+ Bio_11_2006_2016_average+ Bio_19_2006_2016_average+Hyde_Year_2005
...
gm1<-gam(pa~ s(Bio_1_2006_2016_average)+s(Bio_2_2006_2016_average)+s(Bio_4_2006_2016_average)+ s(Bio_5_2006_2016_average)+s(Bio_6_2006_2016_average)+ 
           s(Bio_11_2006_2016_average)+ s(Bio_19_2006_2016_average)+ s(Hyde_Year_2005), family = binomial(link = "logit"),data=env_all)
...
gm1<-mgcv:::gam(pa~ s(Bio_1_2006_2016_average)+s(Bio_2_2006_2016_average)+s(Bio_4_2006_2016_average)+s(Bio_5_2006_2016_average)+ s(Bio_6_2006_2016_average)+ 
           s(Bio_11_2006_2016_average)+ s(Bio_19_2006_2016_average)+ s(Hyde_Year_2005), family = binomial(link = "logit"), data=env_all)
