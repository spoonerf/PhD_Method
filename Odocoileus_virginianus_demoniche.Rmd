...
for (i in 1:k){
  ...
  gm1<-gam(pa~ s(Bio_2_2006_2016_average)+s(Bio_4_2006_2016_average)+ s(Bio_6_2006_2016_average)+ 
           s(Bio_11_2006_2016_average)+ s(Bio_19_2006_2016_average)+ + s(Hyde_Year_2005), family = binomial(link = "logit"),data=envtrain)
...
model<-pa~  Bio_2_2006_2016_average+Bio_4_2006_2016_average+ 
  ...
  Bio_19_2006_2016_average+ Hyde_Year_2005
...
gm1<-gam(pa~ s(Bio_2_2006_2016_average)+s(Bio_4_2006_2016_average)+ s(Bio_6_2006_2016_average)+ 
           s(Bio_11_2006_2016_average)+ s(Bio_19_2006_2016_average) + s(Hyde_Year_2005), 
         family = binomial(link = "logit"),data=env_all)
...
gm1<-mgcv:::gam(pa~ s(Bio_2_2006_2016_average)+ s(Bio_4_2006_2016_average)+ s(Bio_6_2006_2016_average)+ s(Bio_11_2006_2016_average)+ s(Bio_19_2006_2016_average)+s(Hyde_Year_2005), data=env_all)
