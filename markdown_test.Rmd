...
```{r}
years<-1950:2016
t<-stack(paste(wd,"/Alp_SDMs/Ensembles/weighted_ensemble_sdm_", years,".tif", sep=""))
...
```{r, cache=TRUE, echo=FALSE, eval=FALSE, message=FALSE, warning=FALSE}
...
lambda_preds<-cbind(real,pred, pred_clim,pred_luc,  demo_link_low, demo_link_mid,demo_link_high,demo_sigk_low, demo_sigk_mid)
