...
sd_seq<-c(0.25,0.5,0.75,1,1.5,2)
sdf_seq<-gsub("\\.", "_", sd_seq)
...
dir.create(paste("D:/Fiona/Git_Method/Git_Method/Demoniche_Repetitions/", s,sep=""))
...
c_ibex_k_16000 <- demoniche_model_me(modelname = "Capra_k_16000", Niche = TRUE, 
                                     Dispersal = TRUE, repetitions = 1,
                                     foldername = paste("Demoniche_Repetitions/", s,"/rep_",i, sep=""))
}
...
for (s in sdf_seq){
  ...
  f<-paste(wd, "/Demoniche_Repetitions/",s, sep="")
...
#path<-paste(f, lf, sep="")
  ...
  ggplot(rep_df, aes(x = year, y= trend, group=id))+
    geom_line( alpha=0.5)
  ...
  ggplot(rep_df_short, aes(x = year, y= trend, group=id))+
    geom_line( alpha=0.5)
