...
#path<-paste(f, lf, sep="")
  ...
  spin<-ggplot(rep_df, aes(x = year, y= trend, group=id))+
    geom_line( alpha=0.5)
  #geom_line(aes(x = year, y=p_16000))
  plot(spin)
...
#ggplot groups of data e.g all data with 0.5 LDD
...
p01<-ggplot(df_ldd_01, aes(x=year, y=trend, colour=sdd_id))+
  geom_line()
...
p05<-ggplot(df_ldd_05, aes(x=year, y=trend, colour=sdd_id))+
  geom_line()
...
p09<-ggplot(df_ldd_09, aes(x=year, y=trend, colour=sdd_id))+
  geom_line()
