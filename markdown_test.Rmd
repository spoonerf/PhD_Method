...
demoniche_setup(modelname = "patch_ltk_low_disp",Populations = Populations, Nichemap =patch_map_mine,
                ...
                no_yrs = no_yrs_mine, K=ltks[,2:968], Kweight = K_weight, 
                sumweight =sumweight)
...
years<-1050:2016
plot(years,patch_run[,"Meanpop","Reference_matrix"], type="l", xlim=c(1949,2016))
...
pop_out<-read.csv(paste(wd, "/patch_ltk_high_disp/pop_output.csv", sep=""), header=T)
pop_out<-pop_out[,-1]
