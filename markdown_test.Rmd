...
start.time <- Sys.time()
 ...
 max_disp<-as.character(kern_mat[s,2])
  dir.create(paste(demoniche_folder,"/patch_old_disp",max_disp,sep=""),showWarnings = TRUE)
...
c_ibex_k_16000 <- demoniche_model_me(modelname = binomial, Niche = TRUE, 
                                     ...
                                     foldername = paste(binomial,"/Demoniche_Output/patch_old_disp",max_disp,"/",i, sep=""))
}
...
highfoldernames<-highfoldernames[7:10]
