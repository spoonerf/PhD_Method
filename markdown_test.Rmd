...
load("D:/Fiona/Git_Method/Git_Method/non_damaris_function/Projection_rep1_Reference_matrix.rda")
pr1<-Projection
plot(colSums(pr1[1,1,1:530,917:ncol(pr1[1,1,1:530,])]), type="l")
plot(colSums(pr1[1,1,1:530,]), type="l")
load("D:/Fiona/Git_Method/Git_Method/non_damaris_function/Projection_rep2_Reference_matrix.rda")
pr2<-Projection
plot(colSums(pr2[1,1,1:530,]), type="l", col="red")
load("D:/Fiona/Git_Method/Git_Method/non_damaris_function/Projection_rep3_Reference_matrix.rda")
pr3<-Projection
plot(colSums(pr3[1,1,1:530,]), type="l", col="blue")
load("D:/Fiona/Git_Method/Git_Method/non_damaris_function/Projection_rep4_Reference_matrix.rda")
pr4<-Projection
plot(colSums(pr4[1,1,1:530,]), type="l", col="green")
load("D:/Fiona/Git_Method/Git_Method/non_damaris_function/Projection_rep5_Reference_matrix.rda")
pr5<-Projection
plot(colSums(pr4[1,1,1:530,]), type="l", col="pink")

f<-"D:/Fiona/Git_Method/Git_Method/non_damaris_function/"

lf<-list.files(f, pattern="*matrix.rda")
