...
foldernames<-c("patch_link_low_disp" ,"patch_link_mid_disp" ,"patch_link_high_disp","patch_ltk_low_disp" ,"patch_ltk_mid_disp" ,"patch_ltk_high_disp" ,"patch_sigk_low_disp" ,"patch_sigk_mid_disp" ,"patch_sigk_high_disp")


k_relationships<-rep(list(links, sigks, ltks), each=3)
