...
patch_tss<-stack(paste(wd,"/Alp_SDMs/Ensembles_2006_2016/pres_abs_kappa_weighted_ensemble_sdm_", years,".tif", sep=""))
...
plot(years,mno, type="l", main="Predicted patch presence - no omission", ylab="Suitable squares", xlab="Years")
