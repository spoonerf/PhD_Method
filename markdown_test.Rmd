...
for (i in 1:length(years)){
  ...
  sdm_patch_df<-cbind(sdm_patch_df,vec)
  print(i)
}
...
demoniche_setup(modelname = "Capra_ibex_patch",Populations = Populations, Nichemap = patch_map_mine,
...
patch_run <- demoniche_model(modelname = "Capra_ibex_patch", Niche = TRUE, 
                                     Dispersal = TRUE, repetitions = 1,
                                     foldername = "RPyran_disp_niche")

patch_run <- demoniche_model_VE(modelname = "Capra_ibex", Niche = TRUE, 
                                     Dispersal = FALSE, repetitions = 1,
                                     foldername = "RPyran_disp_niche")

patch_run[,"Meanpop","Reference_matrix"]
...
lin_all <- demoniche_model(modelname = "Capra_ibex_lin_all", Niche = TRUE, 
                                     Dispersal = TRUE, repetitions = 1,
                                     foldername = "RPyran_disp_niche")
...
```{r}
spin_up<-1050:1949
year0<-paste(wd, "/Alp_SDMs/Ensembles/weighted_ensemble_sdm_1950.tif", sep="")

spin_up_files<-paste(wd, "/Alp_SDMs/Ensembles/weighted_ensemble_sdm_", spin_up,".tif", sep="")
