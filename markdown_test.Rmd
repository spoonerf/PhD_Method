...
=======
```{r, cache=TRUE}
>>>>>>> fb7573042481d104958f87b37fe7f25f6148c6c4
...
k<-5000   #need to find a better way of estimating this - filzbach should work well
lin<-function(x){
  x*k
  }
...
library(demoniche)
demoniche_setup(modelname = "patch_ltk_low_disp",Populations = Populations, Nichemap =pmm,
