...
plot(years_short,colMeans(na.omit(patch_map_mine)[904:length(colnames(patch_map_mine))]), type="l", ylab="Mean suitability index")
...
```{r, eval=FALSE, echo=FALSE, warning=FALSE, "Dispersal Kernel"}
...
```{r, eval=FALSE, echo=FALSE, warning=FALSE, "Dispersal Proportion"}
