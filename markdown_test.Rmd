...
col_years<-paste("Year_", 1049:2016, sep="")
...
demoniche_setup(modelname = "Capra_ibex",Populations = Populations, Nichemap = niche_map_mine,
                ...
                no_yrs = no_yrs_mine, K=NULL, Kweight = K_weight, 
                sumweight =sumweight)
...
plot(years, bleh, type="l", xlab="Number of Alpine Ibex")

plot(years[900:967], bleh[900:967], type="l", xlab="Number of Alpine Ibex")
...
RPyran_disp_niche_scale_lk <- demoniche_model(modelname = "Capra_ibex_scale_lk", Niche = TRUE, 
                                     Dispersal = TRUE, repetitions = 1,
                                     foldername = "RPyran_disp_niche")

RPyran_disp_niche_scale[,"Meanpop","Reference_matrix"]
