...
var_grid<-expand.grid(sd_seq, LDD_seq, k_seq)
colnames(var_grid)<-c("SD", "LDD", "K")
...
dir.create(paste("D:/Fiona/Git_Method/Git_Method/Demoniche_Repetitions/Three_Vars/K_",K,"_LDD_",LDD,"_SD_", SD,sep=""))
...
c_ibex_k_16000 <- demoniche_model_me(modelname = "Capra_k_16000", Niche = TRUE, 
                                     Dispersal = TRUE, repetitions = 1,
                                     foldername = paste("Demoniche_Repetitions/Three_Vars/K_",K,"_LDD_",LDD,"_SD_", SD,"/rep_",i, sep=""))
}
