...
patch<-stack(paste(wd,"/Alp_SDMs/Ensembles/pres_abs_no_emission_weighted_ensemble_sdm_", years,".tif", sep=""))
plot(patch[[s]])

patch_kap<-stack(paste(wd,"/Alp_SDMs/Ensembles/pres_abs_kappa_weighted_ensemble_sdm_", years,".tif", sep=""))
plot(patch_kap[[s]])
...
lines(years,mk, type="l", main="Predicted patch presence", ylab="Suitable squares", xlab="Years", col="red")

mno<-cellStats(patch, stat="sum")
plot(years,mno, type="l", main="Predicted patch presence", ylab="Suitable squares", xlab="Years", ylim=c(0,1100))
