...
transition_affected_niche<-c(2,11,20)   #which parts of the matrix are affected by the c(2,11,20) is first three stages
#niche values

demoniche_setup(modelname = "Capra_ibex",Populations = Populations, Nichemap = patch_map_mine,
...
plot(years, bleh[901:967], type="l")
...
plot(years, bleh, type="l", ylab="Number of Alpine Ibex", xlim=c(1960,2016))
```

```{r}
spin_up<-1050:1949
year0<-paste(wd, "/Alp_SDMs/Ensembles/pres_abs_kappa_weighted_ensemble_sdm_1950.tif", sep="")

spin_up_files<-paste(wd, "/Alp_SDMs/Ensembles/pres_abs_kappa_weighted_ensemble_sdm_", spin_up,".tif", sep="")
