...
```{r}
demoniche_setup(modelname = "Capra_ibex_lin_all",Populations = Populations, Nichemap = niche_map_mine,
                matrices = matrices,matrices_var = matrices_var, prob_scenario = prob_scenario,
                stages = stages, proportion_initial = proportion_initial,
                ...
                transition_affected_env=transition_affected_env,
                env_stochas_type = env_stochas_type,
                no_yrs = no_yrs_mine, K=ltkk_spin_up_comb, Kweight = K_weight, 
                sumweight =sumweight)

lin_all <- demoniche_model_VE(modelname = "Capra_ibex_lin_all", Niche = TRUE, 
                                     Dispersal = TRUE, repetitions = 1,
...
plot(years, bleh, type="l", ylab="Number of Alpine Ibex", xlim=c(1950,2016))
```
