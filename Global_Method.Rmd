...
Realm<-rbind(Realm,Realm2) #sort this has duplicates
...
df2<-subset(dfb, !is.na(Estimate) & r_sq >= 0.4999999  & !is.na(LUC_dist) &length_time >=5 & System!="Marine" &Specific_location == 1 & !is.na(Bodymass)  & !is.na(WWF_REALM2) &Class=="Mammalia" ) #more populations with this?
