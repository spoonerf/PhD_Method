...
df2<-subset(df, !is.na(Estimate)&r_sq >= 0.5  & !is.na(Nat_change)&length_time >=5 & System!="Marine" &Specific_location == 1 & !is.na(Bodymass) &Class=="Aves")
...
for (i in 1:R) {
 ...
 colnames(dt2)[2]<-"ID"
  ...
  marg_Rsq_m0a[i]<-modelsRsq[2,4]
  marg_Rsq_m0b[i]<-modelsRsq[3,4]
  marg_Rsq_m0c[i]<-modelsRsq[4,4]
  marg_Rsq_m0d[i]<-modelsRsq[5,4]
  marg_Rsq_m1[i]<-modelsRsq[6,4]
  marg_Rsq_m1a[i]<-modelsRsq[7,4]
  marg_Rsq_m1b[i]<-modelsRsq[8,4]
  marg_Rsq_m1c[i]<-modelsRsq[9,4]
  cond_Rsq_m0[i]<-modelsRsq[1,5]
  cond_Rsq_m0a[i]<-modelsRsq[2,5]
  cond_Rsq_m0b[i]<-modelsRsq[3,5]
  cond_Rsq_m0c[i]<-modelsRsq[4,5]
  cond_Rsq_m0d[i]<-modelsRsq[4,5]
  cond_Rsq_m1[i]<-modelsRsq[5,5]
  cond_Rsq_m1a[i]<-modelsRsq[6,5]
  cond_Rsq_m1b[i]<-modelsRsq[7,5]
  cond_Rsq_m1c[i]<-modelsRsq[8,5]
  cond_Rsq_mnull[i]<-modelsRsq[9,5]
