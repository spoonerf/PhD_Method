...
bioclim_layers<-c(1,5,6,8,11,13)
...
species_directory<-paste(wd, "/",binomial, "_bias_EU", sep="")
dir.create(species_directory)
sdm_folder<-paste(species_directory, "SDM_folder_bias_EU", sep = "/")
dir.create(sdm_folder)
demoniche_folder<-paste(species_directory, "Demoniche_Output_bias_EU", sep = "/")
...
targetRecords <- occ_search(
  ...
  fields='minimal',
  decimalLongitude='0,180',
  decimalLatitude='37,84',
  limit=11000
)
...
model<-pa ~  Bio_5_2006_2016_average+Bio_6_2006_2016_average+ 
  Bio_8_2006_2016_average+ Bio_11_2006_2016_average+ Bio_13_2006_2016_average+Hyde_Year_2005
